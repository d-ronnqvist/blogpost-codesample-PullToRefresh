...
- (void)viewDidLoad
{
    ...
    CAShapeLayer *loadShape = [DebugLayer layer];
...
{
//    self.pullToRefreshShape.timeOffset = 0.0;
...
//    dryColor.fromValue = (id)[UIColor grayColor].CGColor;
//    dryColor.fillMode = kCAFillModeBackwards;
//    dryColor.duration = 0.5;
//    dryColor.beginTime = CACurrentMediaTime() + 3.;
//    [self.pullToRefreshShape addAnimation:dryColor forKey:@"Fade the text"];
//    
//    
//    CABasicAnimation *write2 = [CABasicAnimation animationWithKeyPath:@"strokeEnd"];
//    write2.fromValue = @0;
...
//    write2.duration = 0.5;
//    write2.beginTime = CACurrentMediaTime() + 3.0;
//    [self.loadingShape addAnimation:write2 forKey:@"Write that word"];
//}
